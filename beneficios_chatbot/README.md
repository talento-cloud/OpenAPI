# API de talento cloud para Beneficios

En este proyecto se documenta API REST para el módulo de Beneficios pensado para ser consultado por chatbot ClaudIA
